...
export const heroIcons = [
  {
    ...
    name: "Instagram",
    href: "https://www.instagram.com/m_zaid_04/",
  },
  {
    icon: <FacebookCircleLineIcon />,
    name: "Facebook",
    href: "https://www.facebook.com/zaid.azmat.1",
  },
  {
    icon: <LinkedinLineIcon />,
    name: "Linkedin",
    href: "https://www.linkedin.com/in/muhammad-zaid-796169167/",
  },
  // { icon: <YoutubeLineIcon />, name: "YouTube" },
  {
    icon: <GithubLineIcon />,
    name: "GitHub",
...
export const aboutText =
  " Hi, I'm Zaid, An enthusiastic and skilled web developer currently in the final semester of BS Software Engineering. I have a strong foundation in web development, starting from basic HTML, CSS, and JavaScript, and advancing to complex frameworks and databases. Proficient in modern technologies including React, Node.js, Express.js,MongoDB, Next.js, Prisma ORM, PostgreSQL, TypeScript, Redis, and Socket.io. Passionate about building robust, scalable, and efficient web applications.";
...
export const copyRightIcon = <CopyrightLineIcon size={10} />;
// Experience
export const experienceData = [
  {
    ...
    education:
      "Aspire Collage Daska: Focus on computer science, mathematics, and art/design courses.",
    experience: [
  ...
  },
  {
    ...
    education:
      "Associate’s Degree in Web Development or Design: Enroll in a 4-year Software Engineering program covering web development and design principles.",
    experience: [
  ...
  },
  {
    ...
    education:
      "Online Courses and Bootcamps: Focus on specialized areas like front-end frameworks (React) and back-end technologies (Node.js).",
    experience: [
      "Developing some projects in React and node.js"
    ],
  },
  {
    year: 4,
    ...
    experience: [
      "Covering full stack development in web technologies like React nodejs Nextjs and for database , MongoDb PostgreSQL",
  ...
  },
  {
    ...
    experience: [
      "Enhancing with redis socket.io Prisma ORM etc.",
    ],
  },
];
...
export const navbarData = [
  {
    id: "home",
    name: "Home",
    icon: <Home5LineIcon size={16} />,
  },
  {
    id: "about",
    name: "About",
    icon: <UserLineIcon size={16} />,
  },
  {
    id: "experience",
    name: "MyRoad",
    icon: <HistoryLineIcon size={16} />,
  },
  {
    id: "skills",
    name: "Skills",
    icon: <BriefcaseLineIcon size={16} />,
  },
  {
    id: "reviews",
    name: "Reviews",
    icon: <UserStarLineIcon size={16} />,
  },
  {
    id: "projects",
    name: "Projects",
    icon: <ProjectorLineIcon size={16} />,
  },
  {
    id: "pricing",
    name: "Pricing",
    icon: <PriceTag3LineIcon size={16} />,
  },
  {
    id: "contact",
    name: "Contact",
    icon: <ContactsBook2LineIcon size={16} />,
  },
  {
    id: "questions",
    name: "Questions",
    icon: <QuestionAnswerLineIcon size={16} />,
  },
];
...
export const starIcons = [
  { icon: <StarFillIcon />, name: "Full Star" },
  { icon: <StarHalfLineIcon />, name: "Half Star" },
];

// Arrow icons array
export const arrowIcons = [
  { icon: <ArrowLeftSLineIcon />, name: "Left Arrow" },
  { icon: <ArrowRightSLineIcon />, name: "Right Arrow" },
];
